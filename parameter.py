...
def get_parameters():
    ...
    parser.add_argument('--dataset', type=str, default='custom', choices=['lsun', 'celeb', 'custom'])
    parser.add_argument('--use_tensorboard', type=str2bool, default=False)

    # Path
    parser.add_argument('--image_path', type=str, default=r'C:\Users\Rafaela\Desktop\Thesis\finds\00000')
